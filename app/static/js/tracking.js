...
function initTrackingDataTabs(root) {
    ...
    const labelBySelector = [
        ...
        [".trk_test_config_table", "Test Configs"],
...
const ADMIN_MASTER_LABEL_BY_ACTION = [
    ...
    ["/admin/product-test-config-definitions/create", "Test Config Definition"],
    ["/admin/product-test-configs/create", "Test Config"],
